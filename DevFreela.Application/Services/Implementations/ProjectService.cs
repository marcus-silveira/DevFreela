...
public class ProjectService : IProjectService
{
    ...
    public List<ProjectViewModel> GetAll(string query)
    {
        ...
        var projectsViewModel =
            projects.Select(project => new ProjectViewModel(project.Id, project.Title, project.CreatedAt)).ToList();
    ...
    public ProjectDetailsViewModel? GetById(int id)
    {
        ...
        var projectDetails = new ProjectDetailsViewModel(project.Id, project.Title, project.Description,
